...
<form  action="signupback.php" method="POST">
    <section class="absolute bg-sky-100 text-[#0d264f]" style="background-size:90%; width:100%;">
        ...
        <div class="py-8">
            ...
            <div class="text-white rounded-lg bg-[#0d264f] fixed shadow-2xl" style="height: 400px; width: 240px; left: 15%; top: 22%; background-image: url(Image/Signup1.jpg); background-size: contain; box-shadow: inset;">
